...
+ Use ``!create #new_schedule "Hi mom!" 5:45pm`` to create a new event
    * If no message appears in #new_schedule, check to insure Saber-Bot has read, write, and manage message perms
+ To delete the test schedule and event use !delete [schedule|eventID] |or delete the message/channel in discord
...
### Synchronize a Schedule with Google Calendar
